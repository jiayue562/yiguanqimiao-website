...
# 文件路径
INPUT_FILE = r"D:/2020年电脑备份/2020五行出书/1沟通模块/第一期工作坊+5次俱乐部 白纸文字整理-5092-67个小标题.md"
OUTPUT_FILE = r"D:/以观其妙书院知识库/以观其妙书院/01-龙心OS核心系统/第一期工作坊+5次俱乐部-深度学习与知识图谱.md"
...
# 创建深度学习文档
deep_learning = """# 第一期工作坊+5次俱乐部 - 深度学习与知识图谱
...
print(f"📄 内容: 17大章节，涵盖五行人格外观特征、阴阳特征、季节意向描述、交往方式")
